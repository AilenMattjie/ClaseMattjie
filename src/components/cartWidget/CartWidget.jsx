...
const CartWidget = () =>{
    return (
        <div>
            <button type="button" className="btn btn-outline bag ligth">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"  className="bi bi-bag-heart light" viewBox="0 0 16 16">
